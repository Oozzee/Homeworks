...
if __name__ == '__main__':
    a = deque(input('Введите первое число в формате (только цифры от ноля до F): ').upper())
    b = deque(input('Введите первое число в формате (только цифры от ноля до F): ').upper())
